...
export function measure_s(ingredient) {
  '%0.2f' % measure
}

export function lead_time_s(ingredient) {
  lead_time.to_s
}

export function label(ingredient) {
...
export function ingredientCost(recipe, ingredient) {
...
export function cost_s(ingredient) {
  '%0.4f' % cost
}