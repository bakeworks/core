...
function instantiate(code, sequence) {
  ...
  let batchTypes = _batching.default.all;
  let defaultBatchSizing = _batching.default.VARIABLE;

  switch (code) {
    case BAKE_CODE:
      defaultBatchSizing = _batching.default.NONE;

    case SHAPE_CODE:
      batchTypes = [_batching.default.FIXED];
      defaultBatchSizing = _batching.default.FIXED;
  ...
  return {
    code: code,
    label: _string.default.capitalize(code),
    sequence: sequence,
    ...
    defaultOrigin: code === WEIGH_CODE ? _origins.default.SUPPLIED : _origins.default.PRODUCED,
    defaultStatus: code === BAKE_CODE ? _status.default.FINISHED : _status.default.INGREDIENT,
